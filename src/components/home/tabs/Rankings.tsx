...
const Rankings = () => {
  ...
  const cards = [
    { link: College1, title: 'MBBS Colleges', content: 'Top MBBS Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
    { link: College2, title: 'MD Colleges', content: 'Top MD Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
    { link: College3, title: 'MS Colleges', content: 'Top MS Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
    { link: College4, title: 'BAMS Colleges', content: 'Top BAMS Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
    { link: College5, title: 'BPT Colleges', content: 'Top BPT Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
    { link: College6, title: 'M.F.Sc Colleges', content: 'Top M.F.Sc Colleges in Tamil Nadu: Rankings, Facilities, Placements, and More' },
  ];
